...
hero:
  ...
  tagline: "A streaming trading terminal on the Wickra core — live charts, order-book, tape and 497 indicators — with a native TUI and a Web front-end as two renderers over the same logic."
  image:
    src: /wickra-mark.svg
    alt: Wickra Terminal
  actions:
...
features:
  ...
  - icon: 📊
    title: 497 streaming indicators
    details: "Live charts, order-book and tape panels driven by 497 of the Wickra indicator set — price, bar, tape, order-book and pairwise inputs — updated tick by tick on a streaming O(1) state."
  - icon: 🧩
