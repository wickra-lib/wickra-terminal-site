...
const structuredData = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'A streaming trading terminal on the Wickra core — live charts, order-book, tape and 497 indicators — with a native TUI and a Web renderer, in ten languages.',
  ...
  head: [
    ...
    [
      'meta',
      {
        ...
        content:
          'A streaming trading terminal on the Wickra core: live charts, order-book, tape and 497 indicators, with a native TUI and a Web renderer sharing one data-driven core, in ten languages.',
      },
    ],
